...
//clean the deatail of book when remove books.
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(com_cover, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(120, 120, 120))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(com_cover, javax.swing.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(ComViewBook)
                .addContainerGap())
        );
    ...
    private void ComViewBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComViewBookActionPerformed
        ...
        new SuperUserCheckBook("complaints",rowID,bookname).setVisible(true);
    ...
    private void ApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ApproveActionPerformed
        ...
        try{
            ...
            byte[] bookfile_bytes=bookfile.getBytes(pos,len);
            pst.setBinaryStream(8,new ByteArrayInputStream(bookfile_bytes),bookfile_bytes.length);   
    ...
    private void RegularUseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegularUseActionPerformed
        ...
        new tabpannedUserPage("Super User",username, firstname).setVisible(true);
        cancel();

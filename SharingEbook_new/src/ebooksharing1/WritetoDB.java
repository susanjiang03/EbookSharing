...
public class WritetoDB {
    ...
    String bookPath = "/Users/lingshanjiang/desktop/alltables.txt";
    String bookCover = "/Users/lingshanjiang/desktop/mengxiang.jpg";
...
"            reward_points,reading_points) values (?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?)";
            PreparedStatement statement = conn.prepareStatement(sql);
            //statement.setString(1, "3886");
            //statement.setInt(1, 1);
            statement.setString(1, "user6");
            statement.setString(2, "test233");
            InputStream inputBookCover = new FileInputStream(new File(bookCover));
            statement.setBlob(3, inputBookCover);
            statement.setString(4, "author28388");
            statement.setString(5, "commodo at, libero.volutpat nunc sit amet metus. Aliquam erat volutpat. Nulla facilisis. Suspendisse commodo tincidunt nibh. \n" +
"            Phasellus nulla. Integer vulputate, risus a ultricies adipiscing, enim mi tempor lorem, eget mollis lectus pede et risus. Quisque \n" +
"            libero lacus, varius et, euismod et,  Morbi accumsan laoreet ipsum. Curabitur consequatDuis volutpat nunc sit amet metus. Aliquam erat volutpat. Nulla facilisis. Suspendisse commodo tincidunt nibh. \n" +
"            Phasellus nulla. Integer vulputate, risus a ultricies adipiscing, enim mi tempor lorem, eget mollis lectus pede et risus. Quisque \n" +
"            libero lacus, varius et, euismod et, commodo at, libero. Morbi accumsan laoreet ipsum ");
